...
Our GPU-accelerated implementation of probabilistic record linkage relies heavily on the [CuPy](https://cupy.dev) library. CuPy is an open-source library for GPU-accelerated array-based numerical computations in Python. It is built on CUDA, a highly parallel computing platform and programming model developed by NVIDIA. Its interface closely mirrors that of NumPy. This similarity provides an intuitive solution for experienced Python developers aiming to harness GPU computing capabilities.
